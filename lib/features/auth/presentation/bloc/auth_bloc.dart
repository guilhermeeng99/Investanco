...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  Future<void> _onSignInRequested(
    ...
    result.fold(
      // Always show a localized message — never a raw (English, developer-facing)
      // Failure.message. failureMessage maps the owner-rejection to its specific
      // copy and any provider/transport error to the generic localized error.
      (failure) => emit(AuthUnauthenticated(message: failureMessage(failure))),
