...
the landing page is served at the Pages root (`/Investanco/`) and the Flutter web
app one level down (`/Investanco/app/`). The "Open the app" links point at
`./app/` and the Android button at `./investanco.apk`.
